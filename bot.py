...
# --- 2. PARAMETRI E TICKERS (Configurazione Aggiornata) ---
TICKERS = {
    # Core Tech & AI
    "Nvidia": "NVDA", "Tesla": "TSLA", "AMD": "AMD", "ASML": "ASML",
    "CoreWeave": "CRWV",  # Nuova IPO AI
    
    # Valore & Infrastrutture
    "JPMorgan": "JPM", "Visa": "V", "Walmart": "WMT", "Costco": "COST",
    "ExxonMobil": "XOM", "Caterpillar": "CAT", "Lockheed": "LMT",
    "Loar Group": "LOAR", # Nuova IPO Difesa
    "Lineage": "LINE",    # Nuova IPO Logistica
    
    # Pharma & Altro
    "Eli Lilly": "LLY", "Novo Nordisk": "NVO", "Coinbase": "COIN"
}
