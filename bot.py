...
# TICKER AGGIORNATI: Rimosse le mega-cap a bassa volatilità, inserite IPO recenti e High-Beta
SETTORI = {
    "XLK": {"nome_settore": "💻 TECH / SOFTWARE", "tickers": {"Microsoft": "MSFT", "Apple": "AAPL", "Salesforce": "CRM", "Tempus AI": "TEM", "ServiceNow": "NOW", "Ibotta": "IBTA", "Palo Alto": "PANW", "CrowdStrike": "CRWD", "Palantir": "PLTR", "Meta": "META", "Netflix": "NFLX", "Snowflake": "SNOW", "Datadog": "DDOG", "Reddit": "RDDT", "Rubrik": "RBRK"}},
    "SMH": {"nome_settore": "🧠 AI & CHIP", "tickers": {"Nvidia": "NVDA", "AMD": "AMD", "TSMC": "TSM", "ASML": "ASML", "Broadcom": "AVGO", "Qualcomm": "QCOM", "Applied Mat": "AMAT", "Cerebras": "CERE", "Micron": "MU", "SoundHound": "SOUN", "Marvell": "MRVL", "Monolithic": "MPWR", "ARM": "ARM", "Astera Labs": "ALAB", "CoreWeave": "CRWV"}},
    "XLF": {"nome_settore": "🏦 FINANZA E FINTECH", "tickers": {"JPMorgan": "JPM", "BofA": "BAC", "Nu Holdings": "NU", "Dave": "DAVE", "Goldman Sachs": "GS", "Morgan Stanley": "MS", "Visa": "V", "Mastercard": "MA", "Coinbase": "COIN", "Robinhood": "HOOD", "SoFi": "SOFI", "Upstart": "UPST", "Affirm": "AFRM", "Bowhead Specialty": "BOW", "MoneyLion": "MNY"}},
    "XLE": {"nome_settore": "🛢️ ENERGIA", "tickers": {"Exxon": "XOM", "Fluence": "FLNC", "Kinetik": "KNTK", "Schlumberger": "SLB", "EOG Resources": "EOG", "Marathon": "MPC", "Occidental": "OXY", "Valero": "VLO", "Williams": "WMB", "Halliburton": "HAL", "Pioneer": "PXD", "Hess": "HES", "Baker Hughes": "BKR", "BKV Corp": "BKV", "TXO Partners": "TXO"}},
    "ITA": {"nome_settore": "🪖 DIFESA E SPAZIO", "tickers": {"Lockheed": "LMT", "RTX Corp": "RTX", "Northrop": "NOC", "Rocket Lab": "RKLB", "Intuitive Mach": "LUNR", "TransDigm": "TDG", "Heico": "HEI", "L3Harris": "LHX", "Textron": "TXT", "Howmet": "HWM", "Spirit Aero": "SPR", "Woodward": "WWD", "Moog": "MOG-A", "Loar Group": "LOAR", "AST SpaceMobile": "ASTS"}},
    "XBI": {"nome_settore": "🧬 BIOTECH & HEALTH", "tickers": {"Eli Lilly": "LLY", "Novo Nordisk": "NVO", "UnitedHealth": "UNH", "Viking": "VKTX", "Merck": "MRK", "AbbVie": "ABBV", "Structure": "GPCR", "Vertex": "VRTX", "Amgen": "AMGN", "Gilead": "GILD", "Regeneron": "REGN", "Intuitive Surg": "ISRG", "CRISPR": "CRSP", "CG Oncology": "CGON", "Kyverna": "KYTX"}}
}
